...
namespace Cajero.Vistas
{
    public partial class frmDepositos : Form
    {
        ...
        private Saldo saldo;
        public frmDepositos(frmPanelUsuario frmPanelUsuario, DataBaseConexion conexion, UsuarioM usuario, CajeroM cajero)
        {
            InitializeComponent();
        ...
        private void btnDepositar_Click(object sender, EventArgs e)
        {
            ...
            if ((saldo.SaldoDisponible + totalDinero) > saldo.Limite)
            {
                frmPanelUsuario.Show();
                this.Close();
                MessageBox.Show("La cantidad de deposito supero la capacidad del cajero");
                return;
            }
            ...
            conexion.InsertarTransaccion(usuario.Id, "Deposito", totalDinero, cajero.Id);
            conexion.ActualizarSaldoCuenta(usuario.Id, usuario.SaldoActual + totalDinero);
            frmPanelUsuario.Show();
            this.Close();
            MessageBox.Show("Deposito hecho exitosamente");
        }
